...
// in sleep/test/domain/usecases/end_sleep_tracking_usecase_test.dart.
...
import 'package:sleep/domain/repositories/user_repository.dart' as _i5;
...
class MockUserRepository extends _i1.Mock implements _i5.UserRepository {
  ...
  @override
  _i4.Future<_i6.UserProfile?> getUserProfile() => (super.noSuchMethod(
        Invocation.method(
          #getUserProfile,
          [],
        ),
  ...
  @override
  _i4.Future<void> updatePoints(int? points) => (super.noSuchMethod(
        Invocation.method(
          #updatePoints,
          [points],
        ),
