...
class _EditSleepDialogState extends State<EditSleepDialog> {
  ...
  late double? _qualityScore;
  late int? _wakeQuality;
  ...
  void initState() {
    ...
    _qualityScore = widget.session.qualityScore;
    _wakeQuality = widget.session.wakeQuality;
    _qualityController.text = _qualityScore?.toInt().toString() ?? '';
  }
  ...
  Widget _buildTimeSection(
    ...
    return Column(
      ...
      children: [
          ...
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () => _pickDate(currentTime ?? DateTime.now(), onChanged),
            ...
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () => _pickTime(currentTime ?? DateTime.now(), onChanged),
        ...
        if (isOptional && currentTime != null) ...[
          const SizedBox(height: 8),
          TextButton.icon(
            onPressed: () {
              setState(() {
  ...
  void _saveChanges() {
    ...
    final updatedSession = widget.session.copyWith(
      ...
      duration: _endTime != null ? _endTime!.difference(_startTime) : null,
    );
